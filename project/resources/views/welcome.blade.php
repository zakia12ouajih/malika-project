                    ...
                    <div class="container">
                        ...
                        <div class="collapse  navbar-collapse" id="collapsibleNavId">
                            <ul class="nav navbar-nav w-100 justify-content-end me-auto mt-2 mt-lg-0">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link text-white" href="/create">Services</a>
                                </li>
                                <li class="nav-item">
                                    @if (Route::has('login'))
                                        @auth
                ...
                <div class="row">
                    <div class="col-3  mb-2">
                        <div class="card text-start">
                            <img class="img-card-top img-fluid" style="width: 300px; height: 350px; object-fit: cover;" src="images/photo2.jpg"  >
                            <div class="card-body">
                                <h4 class="card-title">malika id mohamed</h4>
                    ...
                    <div class="col-3  mb-2">
                        <div class="card text-start">
                            <img src="images/photo8.webp" style="width: 300px; height: 350px; object-fit: cover;"  class="img-card-top img-fluid">
                            <div class="card-body">
                                <h4 class="card-title">malika id mohamed</h4>
                                <p class="card-text">Les informations</p>
                            </div>
                    ...
                    <div class="col-3 mb-2">
                        <div class="card text-start">
                            <img src="images/photo7.webp" style="width: 300px; height: 350px; object-fit: cover;" class="img-card-top img-fluid" >
                            <div class="card-body">
                                <h4 class="card-title">malika id mohamed</h4>
                                <p class="card-text">Les informations</p>
                            </div>
                    ...
                    <div class="col-3 ">
                        <div class="card text-start">
                            <img src="images/photo6.webp" style="width: 300px; height: 350px; object-fit: cover;" class="img-card-top img-fluid">
                            <div class="card-body">
                                <h4 class="card-title">malika id mohamed</h4>
                                <p class="card-text">Les informations</p>
                            </div>
                    ...
                    <div class="col-3 mt-2 mb-2">
                        <div class="card text-start">
                            <img src="images/photo5.webp" style="width: 300px; height: 350px; object-fit: cover;" class="img-card-top img-fluid" >
                            <div class="card-body">
                                <h4 class="card-title">malika id mohamed</h4>
                                <p class="card-text">Les informations</p>
                            </div>
                    ...
                    <div class="col-3 mt-2 mb-2">
                        <div class="card text-start">
                            <img src="images/photo10.webp" style="width: 300px; height: 350px; object-fit: cover;" class="img-card-top img-fluid" >
                            <div class="card-body">
                                <h4 class="card-title">malika id mohamed</h4>
                                <p class="card-text">Les informations</p>
                            </div>
                    ...
                    <div class="col-3 mt-2 mb-2">
                        <div class="card text-start">
                            <img src="images/phtoto3.webp" style="width: 300px; height: 350px; object-fit: cover;" class="img-card-top img-fluid" >
                            <div class="card-body">
                                <h4 class="card-title">malika id mohamed</h4>
                                <p class="card-text">Les informations</p>
                            </div>
                    ...
                    <div class="col-3 mt-2 mb-2">
                        <div class="card text-start">
                            <img src="images/photo2.jpg" style="width: 300px; height: 350px; object-fit: cover;" class="img-card-top img-fluid" >
                            <div class="card-body">
                                <h4 class="card-title">malika id mohamed</h4>
                                <p class="card-text">Les informations</p>
                            </div>
                    ...
                    <div class="col-3 mt-2 mb-2">
                        <div class="card text-start">
                            <img src="images/photo4.jpg" style="width: 300px; height: 350px; object-fit: cover;" class="img-card-top img-fluid" >
                            <div class="card-body">
                                <h4 class="card-title">malika id mohamed</h4>
                                <p class="card-text">Les informations</p>
                            </div>
